---
layout: post
title:  "(Win32 : WindowsProgramming-23) Virtual Memory Allocation"
summary: ""
author: win32
...
usemathjax: false
permalink: /blog/win32/WindowsProgramming-23/
---
...
* 예약(RESERVE)
    * 실제 물리 공간에 메모리를 할당하지 않고 주소 공간만 확보
...
여기서 문제가 있는데 CELL의 크기가 4k가 아니라 4k-5라서 메모리가 할당될시 PAGE(4k) 단위로 할당이 되기에 index 1을 하더라도 5바이트 이내이면 PAGE가 할당이 안됨.
