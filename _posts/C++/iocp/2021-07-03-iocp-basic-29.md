---
layout: post
title:  "(C++ : IOCP-29) 소켓옵션"
summary: ""
author: C++
date: '2021-07-03 0:00:00 +0000'
category: ['Cpp', 'iocp']
#tags: ['C++', 'tag-test1']
thumbnail: /assets/img/posts/cpp-thumnail.png
#keywords: ['unique_ptr']
usemathjax: true
permalink: /blog/cpp/iocp/basic/29/
---

setsockopt

* [MSDN](https://docs.microsoft.com/en-us/windows/win32/api/winsock/nf-winsock-setsockopt)
...
```cpp
// 2. 어떤옵션을 선택할 것인가? (매우 많기에 많이쓰는거만 정리)
