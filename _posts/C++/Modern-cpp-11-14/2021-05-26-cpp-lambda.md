...
#keywords: ['unique_ptr']
usemathjax: true
permalink: /blog/cpp/modern-cpp-11-14/lambda/
---
...
public:
    ...
    int operator()() const
    {
        v1 = 10;
        v2 = 20;    
        // operator()()가 상수더라도 값자체를 바꾸는 것이아니라 참조형이 가리키는 곳을 변경하기에 변경가능!
    }
};
auto f1 = ClosureType(v1, v2);
```
