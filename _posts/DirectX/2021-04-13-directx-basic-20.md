---
layout: post
title:  "(DirectX : Basic) 20. Resource"
summary: ""
author: DirectX
...
* [GetCode](https://github.com/EasyCoding-7/DirectX-Basic/tree/master/14)
...
이제 Object를 부모로 각종 클래스를 생성할 예정<br>
코드를 변경하며 각 클래스에 대한 간단한 설명도 추가한다.
...
```cpp
// enable_shared_from_this<GameObject> : this포인터를 스마트 포인터로 사용
